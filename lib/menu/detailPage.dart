          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 15.0),
                Container(
                  child: Text('ອາຫານທີ່ປຸງແຕ່ງໃນຮ້ານນີ້ເເຊບ, ມີສານອາຫານທີ່ສົມດຸນ, ຖືກເລືອກຈາກສ່ວນປະກອບທີ່ມີຄຸນນະພາບສູງ ອາຫານແຊບໆນີ້ອາດຈະເປັນທາງເລືອກທີ່ດີທີ່ສຸດຕໍ່ສຸຂະພາບຂອງທ່ານ.',
                    style: TextStyle(
                        fontSize: 14.0,
                        color: Colors.grey
                    ),
